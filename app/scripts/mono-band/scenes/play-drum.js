...
/**
 * @fileoverview PlayDrum シーンを定義します。
 *
...
/**
 * 新しい PlayDrum クラスのインスタンスを生成します。
 * @constructor
 * @extends {FrontCore.Scene}
 */
MonoBand.Scenes.PlayDrum = function() {
...
MonoBand.Scenes.PlayDrum.prototype = Object.create(FrontCore.Scene.prototype);
MonoBand.Scenes.PlayDrum.prototype.constructor = MonoBand.Scenes.PlayDrum;


/**
 * シーンで表示するデータおよび表示要素を初期化します。
 */
MonoBand.Scenes.PlayDrum.prototype.load = function() {
  if(!this.isLoaded()) {
 ...
 * シーンの表示要素を表示します。
 */
MonoBand.Scenes.PlayDrum.prototype.show = function() {
 ...
 * シーンの表示要素を非表示します。
 */
MonoBand.Scenes.PlayDrum.prototype.hide = function() {
 ...
 */
MonoBand.Scenes.PlayDrum.prototype.updateLayout = function() {
