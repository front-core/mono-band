...
/**
 * @fileoverview PlayKeyboard シーンを定義します。
 *
...
/**
 * 新しい PlayKeyboard クラスのインスタンスを生成します。
 * @constructor
 * @extends {FrontCore.Scene}
 */
MonoBand.Scenes.PlayKeyboard = function() {
...
MonoBand.Scenes.PlayKeyboard.prototype = Object.create(FrontCore.Scene.prototype);
MonoBand.Scenes.PlayKeyboard.prototype.constructor = MonoBand.Scenes.PlayKeyboard;


/**
 * シーンで表示するデータおよび表示要素を初期化します。
 */
MonoBand.Scenes.PlayKeyboard.prototype.load = function() {
  if(!this.isLoaded()) {
 ...
 * シーンの表示要素を表示します。
 */
MonoBand.Scenes.PlayKeyboard.prototype.show = function() {
 ...
 * シーンの表示要素を非表示します。
 */
MonoBand.Scenes.PlayKeyboard.prototype.hide = function() {
 ...
 */
MonoBand.Scenes.PlayKeyboard.prototype.updateLayout = function() {
