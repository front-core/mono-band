...
/**
 * @fileoverview PlayGuitar シーンを定義します。
 *
...
/**
 * 新しい PlayGuitar クラスのインスタンスを生成します。
 * @constructor
 * @extends {FrontCore.Scene}
 */
MonoBand.Scenes.PlayGuitar = function() {
 ...
 */
MonoBand.Scenes.PlayGuitar.prototype.load = function() {
  if(!this.isLoaded()) {
 ...
 * シーンの表示要素を表示します。
 */
MonoBand.Scenes.PlayGuitar.prototype.show = function() {
 ...
 * シーンの表示要素を非表示します。
 */
MonoBand.Scenes.PlayGuitar.prototype.hide = function() {
 ...
 */
MonoBand.Scenes.PlayGuitar.prototype.updateLayout = function() {
